    ...
    public void configure(HttpSecurity http) throws Exception{
        ...
        http.csrf().disable()
            ...
            .authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/users").hasAnyAuthority(ADM)
                .antMatchers(HttpMethod.GET,"/users/*").hasAnyAuthority(USUARIO,GESTOR)
                .antMatchers(HttpMethod.POST,"/lista").hasAnyAuthority(USUARIO)
            .and()
                .exceptionHandling()
